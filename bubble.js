// Setting
const resourcePath = 'resource/bubble/';
const waveMaxAge = 24;

// The array to store all bubble
let bubbleArray=[];
...
// Create bubble on mouse position
...
// Entry point
function bubbleJs() {
    window.addEventListener('click', createBubbleOnMouse);
    window.setInterval(runAllBubble, 10);
}

window.addEventListener('load', bubbleJs);
